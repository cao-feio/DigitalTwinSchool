...
const ClassicalLibrary = ({ data, isSelected, isFaded, onClick }) => {
  ...
  <group position={data.position} scale={data.scale} onClick={onClick} renderOrder={isFaded ? 10 : 0}>
    {/* 基座 */}
    <Box position={[0, 2, 0]} args={[28, 4, 22]} castShadow receiveShadow>
    ...
    {/* 主体 */}
    <Box position={[0, 10, 0]} args={[24, 12, 18]} castShadow receiveShadow>
      <meshStandardMaterial 
    ...
    {Array.from({ length: 4 }).map((_, i) => (
      <group key={`lib-win-row-${i}`}>
        {Array.from({ length: 5 }).map((_, j) => (
          <Box key={`lib-win-${i}-${j}`} position={[-10 + j * 5, 5 + i * 3, 9.1]} args={[3, 2, 0.2]} castShadow receiveShadow>
            <meshStandardMaterial 
              color="#87CEEB" 
              emissive="#aaddff" 
    ...
    {/* 柱子 */}
    {[-10, -5, 0, 5, 10].map(x => (
      <Cylinder key={x} position={[x, 14, -9.5]} args={[0.8, 0.8, 10, 16]} castShadow receiveShadow>
        <meshStandardMaterial 
          color="#e0d0c0" 
          transparent={isFaded} 
    ...
    <group position={[0, 20, -5]}>
      <Box position={[0, 3, 0]} args={[26, 0.5, 2]} castShadow receiveShadow>
        <meshStandardMaterial 
          color="#d0c0b0" 
          transparent={isFaded} 
          opacity={isFaded ? 0.35 : 1} 
      ...
      {[-13, 13].map(x => (
        <Box key={x} position={[x, 1.5, 0]} args={[0.5, 3, 2]} rotation={[0, 0, x > 0 ? 0.8 : -0.8]} castShadow receiveShadow>
          <meshStandardMaterial 
            color="#d0c0b0" 
            transparent={isFaded} 
            opacity={isFaded ? 0.35 : 1} 
    ...
    {/* 穹顶 */}
    <Sphere position={[0, 24, 0]} args={[6, 16, 16]} scale={[1, 0.6, 1]} castShadow receiveShadow>
      <meshStandardMaterial 
...
const ModernBuilding = ({ data, isSelected, isFaded, onClick }) => {
  ...
  <group position={data.position} scale={data.scale} onClick={onClick} renderOrder={isFaded ? 10 : 0}>
    {/* 主楼体 */}
    <Box position={[0, 10, 0]} args={[20, 20, 14]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
    ...
    {Array.from({ length: 8 }).map((_, i) => (
      <group key={`mod1-win-row-${i}`}>
        {Array.from({ length: 6 }).map((_, j) => (
          <Box key={`mod1-win-${i}-${j}`} position={[-9 + j * 3.5, 3 + i * 2.5, 7.1]} args={[2.8, 2.2, 0.3]} castShadow receiveShadow>
    ...
    {Array.from({ length: 12 }).map((_, i) => (
      <Box key={i} position={[-11 + i * 2, 10, -7.1]} args={[0.3, 18, 0.2]} castShadow receiveShadow>
    ...
    {/* 入口雨棚 */}
    <Box position={[0, 3, -8]} args={[12, 0.5, 4]} castShadow receiveShadow>
...
const ModernBuilding2 = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* 阶梯状主楼体 */}
    <Box position={[0, 7, 0]} args={[24, 14, 16]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
    ...
    <Box position={[0, 15, 0]} args={[18, 6, 12]} castShadow receiveShadow>
      <meshStandardMaterial 
    ...
    <Box position={[0, 20, 0]} args={[12, 4, 8]} castShadow receiveShadow>
      <meshStandardMaterial 
    ...
    {Array.from({ length: 5 }).map((_, i) => (
      <Box key={i} position={[0, 3 + i * 3.5, -8.1]} args={[24, 0.4, 0.2]} castShadow receiveShadow>
        <meshStandardMaterial 
          color="#506070" 
          transparent={isFaded} 
          opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    {Array.from({ length: 4 }).map((_, i) => (
      <group key={`mod2-win-row-${i}`}>
        {Array.from({ length: 6 }).map((_, j) => (
          <Box key={`mod2-win-${i}-${j}`} position={[-10 + j * 4, 4 + i * 3.5, 8.1]} args={[3, 2.5, 0.25]} castShadow receiveShadow>
            <meshStandardMaterial 
              color="#aaddff" 
              transparent={isFaded} 
...
const IndustrialLab = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* 工业风主体 */}
    <Box position={[0, 9, 0]} args={[26, 18, 18]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    {/* 外露管道装饰 */}
    {[-11, 11].map(x => (
      <Cylinder key={x} position={[x, 9, -9.5]} args={[0.4, 0.4, 18, 8]} castShadow receiveShadow>
        <meshStandardMaterial 
          color="#708090" 
          metalness={0.8} 
          roughness={0.3} 
    ...
    {Array.from({ length: 6 }).map((_, i) => (
      <Box key={i} position={[-10 + i * 4, 9, 9.1]} args={[3.4, 16, 0.3]} castShadow receiveShadow>
        <meshStandardMaterial 
          color="#99bbdd" 
          transparent={isFaded} 
    ...
    {/* 顶部通风塔 */}
    <Box position={[-6, 18.5, 0]} args={[4, 3, 4]} castShadow receiveShadow>
      <meshStandardMaterial 
        color="#607080" 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
...
const GymArena = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* 大跨度主体 */}
    <Box position={[0, 8, 0]} args={[32, 16, 28]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    {Array.from({ length: 9 }).map((_, i) => (
      <Box key={i} position={[-12 + i * 3, 17, 0]} args={[2.5, 2 + i * 0.2, 26]} rotation={[0, 0, i > 4 ? -0.1 * (i - 4) : 0.1 * (4 - i)]} castShadow receiveShadow>
        <meshStandardMaterial 
...
const StudentCenter = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* 流动感的主楼体 */}
    <Box position={[0, 8, 0]} args={[22, 16, 18]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    {/* 圆形装饰 */}
    <Sphere position={[-8, 12, 9]} args={[3, 16, 16]} castShadow receiveShadow>
      <meshStandardMaterial 
...
const DormBuilding = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* 宿舍主体 */}
    <Box position={[0, 9, 0]} args={[20, 18, 14]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    {Array.from({ length: 8 }).map((_, i) => (
      <group key={`dorm-floor-${i}`}>
        {Array.from({ length: 4 }).map((_, j) => (
          <Box key={`dorm-balcony-${i}-${j}`} position={[-6 + j * 4, 2 + i * 2.25, 7.1]} args={[3, 1.8, 1.5]} castShadow receiveShadow>
            <meshStandardMaterial 
              color="#99aabb" 
              transparent={isFaded} 
              opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
...
const DormBuilding2 = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* L型宿舍 */}
    <Box position={[-4, 9, 0]} args={[16, 18, 12]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    <Box position={[8, 9, -4]} args={[12, 18, 10]} castShadow receiveShadow>
      <meshStandardMaterial 
    ...
    {Array.from({ length: 6 }).map((_, i) => (
      <group key={`dorm2-windows-${i}`}>
        <Box position={[-4, 3 + i * 3, 6.1]} args={[14, 2, 0.2]} castShadow receiveShadow>
          <meshStandardMaterial 
            color="#99bbdd" 
            transparent={isFaded} 
            opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
        ...
        <Box position={[8, 3 + i * 3, -1.1]} args={[10, 2, 0.2]} castShadow receiveShadow>
          <meshStandardMaterial 
            color="#99bbdd" 
            transparent={isFaded} 
            opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
...
const Canteen = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* 大跨度单层食堂 */}
    <Box position={[0, 5, 0]} args={[30, 10, 24]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    {/* 高侧窗 */}
    {Array.from({ length: 8 }).map((_, i) => (
      <Box key={i} position={[-12 + i * 3.5, 8, -12.2]} args={[3, 3, 0.3]} castShadow receiveShadow>
        <meshStandardMaterial 
          color="#aaccff" 
          transparent={isFaded} 
    ...
    {/* 入口门廊 */}
    {[-6, 0, 6].map(x => (
      <Cylinder key={x} position={[x, 3, -13]} args={[0.5, 0.5, 6, 12]} castShadow receiveShadow>
        <meshStandardMaterial 
          color="#d4af37" 
          transparent={isFaded} 
          opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    <Box position={[0, 6.5, -13]} args={[20, 1, 3]} castShadow receiveShadow>
      <meshStandardMaterial 
        color="#c0b090" 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
...
const AdminBuilding = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    ...
    {/* 顶部钟楼 */}
    <Box position={[0, 19, 0]} args={[8, 8, 8]} castShadow receiveShadow>
      <meshStandardMaterial 
    ...
    <Sphere position={[0, 24.5, 0]} args={[2.5, 16, 16]} castShadow receiveShadow>
      <meshStandardMaterial 
        color="#d4af37" 
        metalness={0.6} 
        roughness={0.4} 
    ...
    {/* 主入口 */}
    <Box position={[0, 4, -7.2]} args={[10, 8, 0.6]} castShadow receiveShadow>
      <meshStandardMaterial 
        color="#706050" 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    <Box position={[0, 8, -7.5]} args={[14, 0.5, 1]} castShadow receiveShadow>
      <meshStandardMaterial 
        color="#807060" 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
...
const Auditorium = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* 古典风格礼堂 */}
    <Box position={[0, 8, 0]} args={[28, 16, 22]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    {/* 门廊 */}
    {[-8, -4, 0, 4, 8].map(x => (
      <Cylinder key={x} position={[x, 8, -11.5]} args={[0.7, 0.7, 10, 12]} castShadow receiveShadow>
        <meshStandardMaterial 
          color="#e0d0c0" 
          transparent={isFaded} 
          opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    <Box position={[0, 13.5, -11]} args={[20, 1, 3]} castShadow receiveShadow>
      <meshStandardMaterial 
        color="#d0c0b0" 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    {/* 三角楣装饰 */}
    <Box position={[0, 17.5, -6]} args={[24, 0.6, 4]} castShadow receiveShadow>
      <meshStandardMaterial 
        color="#c0b0a0" 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
...
const ArtCenter = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* 艺术中心主楼 */}
    <Box position={[0, 7, 0]} args={[20, 14, 16]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    <Sphere position={[0, 10, 5]} args={[3, 16, 16]} castShadow receiveShadow>
      <meshStandardMaterial 
...
const HistoryMuseum = ({ data, isSelected, isFaded, onClick }) => (
  <group position={data.position} scale={data.scale} onClick={onClick}>
    {/* 小而精致的博物馆 */}
    <Box position={[0, 6, 0]} args={[18, 12, 14]} castShadow receiveShadow>
      <meshStandardMaterial 
        color={isSelected ? '#ffcc00' : data.color} 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    {Array.from({ length: 4 }).map((_, i) => (
      <group key={`museum-row-${i}`}>
        {Array.from({ length: 4 }).map((_, j) => (
          <Box key={`museum-${i}-${j}`} position={[-6 + j * 4, 2.5 + i * 3, 7.1]} args={[3.5, 2.5, 0.2]} castShadow receiveShadow>
            <meshStandardMaterial 
    ...
    {/* 入口门廊 */}
    <Cylinder position={[-4, 4, -7.5]} args={[0.5, 0.5, 8, 12]} castShadow receiveShadow>
      <meshStandardMaterial 
        color="#c0b0a0" 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
    ...
    <Box position={[0, 8.5, -7]} args={[10, 1, 2]} castShadow receiveShadow>
      <meshStandardMaterial 
        color="#b0a090" 
        transparent={isFaded} 
        opacity={isFaded ? 0.15 : 1} depthWrite={!isFaded} depthTest={false} 
